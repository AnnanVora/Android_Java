package annan.example.youtubeapp;
...
public class YoutubeActivity extends YouTubeBaseActivity
    ...
    static final String GOOGLE_API_KEY = "AIzaSyAfuIRs22_SsveN36WKH7BHl3K-wXSWUO0";
    ...
    private YouTubePlayer.PlaybackEventListener playbackEventListener = new YouTubePlayer.PlaybackEventListener() {
        ...
        public void onPaused() {
            Toast.makeText(YoutubeActivity.this, "Video has been paused", Toast.LENGTH_SHORT).show();
        }
    ...
    private YouTubePlayer.PlayerStateChangeListener playerStateChangeListener = new YouTubePlayer.PlayerStateChangeListener() {
        ...
        public void onVideoStarted() {
            Toast.makeText(YoutubeActivity.this, "Video has started. Enjoy!!!", Toast.LENGTH_SHORT).show();
        }

        @Override
        public void onVideoEnded() {
            Toast.makeText(YoutubeActivity.this, "Congratulations. You have completed the video", Toast.LENGTH_SHORT).show();
        }
